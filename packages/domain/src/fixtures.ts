...
export const wearableAssetConfigs: WearableAssetConfig[] = [
  ...
  },
  {
    ...
    hand: 'right',
    layerFiles: {
      bodyVariant: 'assets/art/vanadis/equipment/wearable/feed-scoop/manager-male/body-variant.png',
      back: 'assets/art/vanadis/equipment/wearable/feed-scoop/manager-male/handheld-back.png',
      mask: 'assets/art/vanadis/equipment/wearable/feed-scoop/manager-male/hand-mask.png',
    },
    renderStages: ['body-variant', 'handheld-back', 'hand-mask'],
    hidesBaseParts: ['right-hand-feather'],
    replacesBaseParts: ['right-hand-feather'],
    conflictsWithSlots: ['body'],
